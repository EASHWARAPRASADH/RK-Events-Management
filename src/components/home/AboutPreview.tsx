        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              With over 15 years of experience in Chennai's event planning industry, RK Events and Management™ has built a reputation for delivering creative, elegant, and flawless events that exceed expectations.
            </p>
          ...
          <div className="animate-slide-up">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-xl border border-gray-100">
                <div className="text-center">
                  <div className="text-3xl font-bold text-maroon-800 mb-1">15+</div>
